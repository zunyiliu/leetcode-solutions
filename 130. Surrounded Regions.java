// first find all boundary 'O's, use dfs to search all 'O's that connet to these boundary 'O's, target them, now all
// the other 'O's are definitely surrounded by 'X's
class Solution {
